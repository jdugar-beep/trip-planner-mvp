...
@media (max-width: 430px){.shell{padding:14px}.mobileHero h1{font-size:27px}.split2{grid-template-columns:1fr}.calCell{min-height:70px;padding:5px;border-radius:12px}.tripBar{font-size:9px}.categoryAddRow{grid-template-columns:40px 1fr auto 40px;padding:14px 13px}.categoryIconBubble{width:40px;height:40px}.plusBubble{width:38px;height:38px}.summaryButton{grid-template-columns:40px 1fr auto}.summaryChevron{font-size:11px;padding:7px 8px!important}}
`;
